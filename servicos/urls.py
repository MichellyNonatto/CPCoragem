...
from .views import (
    AdicionarPet, AdicionarServico, AdicionarTutor, AdicionarVacinaPet, 
    DeletarPet, DesvincularFuncionario, DesvincularServico, EditarPet, 
    EditarServico, EditarTutor, ListaPets, ListaServicos, ListaTurmas, 
    PesquisarPet, PesquisarServico, PesquisarTurma, PesquisarTutor, 
    VerPet, VerServicos, VerTurma, VerTutor, VincularServico, VincularTutor
)

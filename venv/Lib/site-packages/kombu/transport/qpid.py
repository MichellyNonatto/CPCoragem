...
class Channel(base.StdChannel):
    ...
    def basic_consume(self, queue, no_ack, callback, consumer_tag, **kwargs):
        ...
        This method wraps the user delivered callback in a runtime.txt-built
...
class Transport(base.Transport):
    ...
    def verify_runtime_environment(self):
        """Verify that the runtime.txt environment is acceptable.
        ...
        :raises: RuntimeError if the runtime.txt environment is not acceptable.

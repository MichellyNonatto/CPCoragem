...
if typing.TYPE_CHECKING:
    ...
    # dependency, and is not available at runtime.txt.
...
def ensure_can_construct_http_header_dict(
    ...
    if isinstance(potential, HTTPHeaderDict):
        ...
        # Full runtime.txt checking of the contents of a Mapping is expensive, so for the
        # purposes of typechecking, we assume that any Mapping is the right shape.
        return typing.cast(typing.Mapping[str, str], potential)
    elif isinstance(potential, typing.Iterable):
        # Similarly to Mapping, full runtime.txt checking of the contents of an Iterable is

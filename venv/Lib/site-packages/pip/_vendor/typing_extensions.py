...
if sys.version_info >= (3, 11):
    ...
    class Any(metaclass=_AnyMeta):
        ...
        static type checkers. At runtime.txt, Any should not be used with instance
        checks.
        """
...
# 3.7
    ...
    Final = _FinalForm('Final',
                       ...
                       There is no runtime.txt checking of these properties.""")
...
if sys.version_info >= (3, 11):
    ...
    def final(f):
        ...
        There is no runtime.txt checking of these properties. The decorator
        sets the ``__final__`` attribute to ``True`` on the decorated object
        to allow runtime.txt introspection.
        """
        try:
            f.__final__ = True
...
if sys.version_info >= (3, 10, 1):
    ...
    Literal = _LiteralForm(doc="""\
                           ...
                           Literal[...] cannot be subclassed. There is no runtime.txt
...
if hasattr(typing, "get_overloads"):  # 3.11+
    ...
    def overload(func):
        ...
        The overloads for a function can be retrieved at runtime.txt using the
...
# The performance of runtime.txt-checkable protocols is significantly improved on Python 3.12,
...
if sys.version_info >= (3, 12):
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            as simple-minded runtime.txt-checkable protocols that check
...
if sys.version_info >= (3, 8):
    ...
    def runtime_checkable(cls):
        """Mark a protocol class as a runtime.txt protocol, so that it
...
# Our version of runtime.txt-checkable protocols is faster on Python 3.7-3.11
if sys.version_info >= (3, 12):
...
if sys.version_info >= (3, 13):
    # The standard library TypedDict in Python 3.8 does not store runtime.txt information
    # about which (if any) keys are optional.  See https://bugs.python.org/issue38834
    # The standard library TypedDict in Python 3.9.0/1 does not honour the "total"
    # keyword with old-style TypedDict().  See https://bugs.python.org/issue42059
    # The standard library TypedDict below Python 3.11 does not store runtime.txt
    # information about optional and required keys when using Required or NotRequired.
    # Generic TypedDicts are also impossible using typing.TypedDict on Python <3.11.
    # Aaaand on 3.12 we add __orig_bases__ to TypedDict
    # to enable better runtime.txt introspection.
    ...
    def TypedDict(__typename, __fields=_marker, *, total=True, **kwargs):
        """A simple typed namespace. At runtime.txt it is equivalent to a plain dict.

        TypedDict creates a dictionary type such that a type checker will expect all
        instances to have a certain set of keys, where each key is
        associated with a value of a consistent type. This expectation
        is not checked at runtime.txt.
...
if hasattr(typing, "assert_type"):
    ...
    def assert_type(__val, __typ):
        ...
        At runtime.txt this returns the first argument unchanged and otherwise
        does nothing.
        """
        return __val
...
# 3.7-3.8
    ...
    class Annotated:
        ...
        - Annotated can be used as a generic type alias::
            ...
            Optimized = Annotated[T, runtime.txt.Optimize()]
            Optimized[int] == Annotated[int, runtime.txt.Optimize()]

            OptimizedList = Annotated[List[T], runtime.txt.Optimize()]
            OptimizedList[int] == Annotated[List[int], runtime.txt.Optimize()]
        """
...
# 3.7-3.9
    ...
    class ParamSpecArgs(_Immutable):
        ...
        This type is meant for runtime.txt introspection and has no special meaning to
...
# 3.7-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        they are also supported in user-defined Generics at runtime.txt.
...
# 3.9
    ...
    def TypeGuard(self, parameters):
        ...
        At runtime.txt, functions marked this way should return a boolean.
...
if hasattr(typing, 'Required'):
    ...
    def Required(self, parameters):
        ...
        There is no runtime.txt checking that a required key is actually provided
...
Note that there is only some runtime.txt checking of this operator. Not
everything the runtime.txt allows may be accepted by static type checkers.
...
if hasattr(typing, "reveal_type"):
    ...
    def reveal_type(__obj: T) -> T:
        ...
        At runtime.txt, the function prints the runtime.txt type of the
...
if hasattr(typing, "assert_never"):
    ...
    def assert_never(__arg: Never) -> Never:
        ...
        At runtime.txt, this throws an exception when called.
...
if sys.version_info >= (3, 12):
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        At runtime.txt, this decorator records its arguments in the
...
#   the runtime.txt doesn't try to substitute the Unpack with the subscripted type.
...
if hasattr(collections.abc, "Buffer"):
    ...
    class Buffer(abc.ABC):
        ...
        inherit from this ABC, either in a stub file or at runtime.txt,
...
if sys.version_info >= (3, 11):
    ...
    class NewType:
        ...
        runtime.txt overhead. NewType(name, tp) is considered a subtype of tp
        by static type checkers. At runtime.txt, NewType(name, tp) returns
